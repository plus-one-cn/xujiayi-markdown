...
每个学校设置一个指挥部，指挥部里必须要挂上已画路线的平面图和分工表。
根据先前的摸查信息，在校区平面图上绘制出路线图，路线上要体现以下点位：
...
>1. 市场部负责组织调配
>2. 校园中心负责出台组织方案
>3. 前端部门互动支援，支援部门包含部门惠山、滨湖、新吴、锡山、梁溪、梁南、梁北、政企、渠道中心9个单位。
>4. 受支援部门负责支援队伍的安排
>5. 人力资源部负责审定考评
>6. 企信、集支负责支援情况数据统计支持
...
>1. 支援单位部门现场支援每一组有一名组长，均要求领导作为组长带队（即部门主任、副主任、区局长、副区局长）。

>2. 支援部门组长原则上安排每小时点报小组的发展数量
